    ...
    <div>
      <h1 className="billing-header">Billing Info</h1>
        ...
        <Form.Row as={Col} className="grid">
          ...
          <Form.Group as={Col} controlId="formGridCityZip">
            <Form.Control size="sm" onChange={handleZipChangeBilling} className={`${zipInputDefault ? zipError ? "is-invalid" : "is-valid" : ""}` } type="zip code" placeholder="Zip Code" required/>
          </Form.Group>
        </Form.Row>
        ...
        <Form.Group as={Col} controlId="formBasicCardNumber">
          <Form.Control size="sm" onChange={handleCardNumberChangeBilling} className={`${cardNumInputDefault ? cardNumError ? "is-invalid" : "is-valid" : "" }`} type="cardnumber" placeholder="Card Number" required/>
        </Form.Group >
        <Form.Row as={Col}  className="grid">
        <Form.Group as={Col} controlId="formBasicExDate">
          <Form.Control size="sm" onChange={handleExDateChangeBilling} className={`${exDateInputDefault ? exDateError ? "is-invalid" : "is-valid" : "" }`} type="tel" placeholder="00/00" required/>
        </Form.Group >
        <Form.Group as={Col} controlId="formBasicCvc">
          <Form.Control size="sm" onChange={handleCvcChangeBilling} className={`${cvcInputDefault ? cvcError ? "is-invalid" : "is-valid" : "" }`} type="cvc" placeholder="CVC" required/>
        </Form.Group >
        </Form.Row>
        <Form.Group as={Col}>
